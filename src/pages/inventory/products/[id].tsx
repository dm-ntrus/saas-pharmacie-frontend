...
export const ProductDetailPage: React.FC = () => {
  ...
  const { data: movementsData } = useQuery({
    queryKey: ["product-controlled-substance-logs", id, movementsPage, movementsPerPage],
    queryFn: () => 
  ...
  if (isLoading) {
    return (
      <Layout title="Produit - PharmacySaaS">
  ...
  return (
    <Layout title={`${product.name} - PharmacySaaS`}>
            ...
            <CardContent className="p-6">
              ...
              <span
                className={`mt-2 inline-block text-xs px-2 py-1 rounded-full ${
                  ...
                  stockStatus.color === 'yellow' ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800'
                }`}
              >
                {stockStatus.label}
              </span>
                    ...
                    >
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Coût unitaire: ${batch.unitCost?.toFixed(2) || "0.00"}
                          </p>
                          {batch.supplier && (
                            <p className="text-sm text-gray-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <p className="text-sm text-gray-500">Prix de vente unitaire</p>
                  <p className="text-2xl font-bold text-gray-900">
      ...
      <CreateBatchModal
        ...
        onConfirm={() => {
          ...
          queryClient.invalidateQueries({ queryKey: ["product-stock-summary", id] });
