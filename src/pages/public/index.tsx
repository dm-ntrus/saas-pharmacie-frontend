  ...
  return (
    <Layout requireAuth={false} showSidebar={false} title="PharmacySaaS - Gestion Moderne des Pharmacies">
      <div className="bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              <div className="flex items-center">
                <div className="h-10 w-10 bg-gradient-to-br from-primary-600 to-primary-700 rounded-xl flex items-center justify-center mr-3 shadow-lg">
                  <HeartIcon className="h-6 w-6 text-white" />
                </div>
                <div>
                  <span className="text-xl font-bold text-gray-900">NakiCode</span>
                  <span className="text-sm text-primary-600 block leading-none">PharmacySaaS</span>
                </div>
              </div>
              ...
              <nav className="hidden md:flex items-center space-x-8">
                ...
                <a href="#resources" className="text-gray-600 hover:text-primary-600 transition-colors font-medium">
                  Ressources
                </a>
              ...
              <div className="flex items-center space-x-3">
                ...
                <Link href="/register">
                  <Button size="sm" className="font-medium shadow-lg">Démo Gratuite</Button>
                </Link>
              </div>
            </div>
          </div>
        ...
        {/* Hero Section */}
        <section className="pt-20 bg-gradient-to-br from-primary-50 via-blue-50 to-white relative overflow-hidden">
          {/* Background decorative elements */}
          <div className="absolute inset-0">
            <div className="absolute top-0 left-0 w-72 h-72 bg-primary-200/20 rounded-full -translate-x-1/2 -translate-y-1/2"></div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto mb-8 leading-relaxed">
                ...
                Jusqu'à <span className="font-bold text-green-600">30% d'augmentation des marges</span> 
                  ...
                  <div className="bg-white rounded-lg p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      <div className="bg-yellow-50 p-3 rounded">
                        ...
                        <div className="h-6 bg-yellow-300 rounded w-16"></div>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
                ...
                <span className="block text-primary-600">pour maximiser sa rentabilité</span>
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              {features.map((feature, index) => (
                <div key={index} className="group bg-white p-8 rounded-2xl shadow-soft hover:shadow-soft-lg transition-all duration-300 hover:-translate-y-1 border border-gray-100">
                  <div className="h-14 w-14 bg-gradient-to-br from-primary-500 to-primary-600 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
            ...
            <div className="bg-gradient-to-r from-primary-600 to-primary-700 rounded-3xl p-8 md:p-12 text-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-primary-100 text-sm">Évitez les ruptures et optimisez vos commandes avec des prévisions IA précises</p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-primary-500/30 rounded-full flex items-center justify-center mx-auto mb-4">
                  ...
                  <p className="text-primary-100 text-sm">Maximisez vos marges avec des stratégies de prix dynamiques et intelligentes</p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-primary-500/30 rounded-full flex items-center justify-center mx-auto mb-4">
                  ...
                  <p className="text-primary-100 text-sm">Personnalisez les promotions et améliorez l'expérience client avec l'IA</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="pricing" className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              {/* Plan Moyenne */}
              <div className="bg-white border-2 border-primary-500 rounded-lg p-6 hover:shadow-lg transition-shadow relative">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
                ...
                <span className="block text-primary-600">qui nous font confiance</span>
              </h2>
              <p className="text-xl text-gray-600 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
              {testimonials.map((testimonial, index) => (
                <div key={index} className="bg-white p-8 rounded-2xl shadow-soft hover:shadow-soft-lg transition-all duration-300 border border-gray-100">
                  ...
                  <div className="flex items-center">
                    <div className="h-14 w-14 bg-gradient-to-br from-primary-500 to-primary-600 rounded-full flex items-center justify-center mr-4 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  ...
                  <li><a href="/training" className="hover:text-white">Formation</a></li>
