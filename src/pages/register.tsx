...
const RegisterPage: NextPage = () => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {plans.map((plan) => (
          ...
          >
            ...
            <div
              className={`w-full mt-auto py-2 px-4 rounded-lg text-center font-semibold ${
                formData.selectedPlan === plan.id
          ...
          <div className="bg-sky-50 rounded-xl px-4 py-2 border border-sky-100">
            <div className="flex justify-between items-center">
              <span className="font-semibold text-gray-700">
                Plan {formData.selectedPlan.charAt(0).toUpperCase() + formData.selectedPlan.slice(1)}
              </span>
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col justify-center items-center  bg-gradient-to-br from-sky-50 via-sky-50 to-white relative overflow-hidden px-2 sm:px-0">
        {/* Background decorative elements */}
        <div className="absolute inset-0">
          <div className="absolute top-0 left-0 w-72 h-72 bg-sky-200/20 rounded-full -translate-x-1/2 -translate-y-1/2"></div>
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-sky-200/20 rounded-full translate-x-1/2 translate-y-1/2"></div>
        </div>
        ...
        <div className="max-w-6xl w-full rounded-2xl bg-white shadow-2xl z-50 mx-auto p-4 sm:p-6 mb-8">
          {renderStepIndicator()}
