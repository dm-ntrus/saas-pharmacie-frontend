...
const ReportsPage: React.FC = () => {
  ...
  return (
    <Layout title="Rapports - PharmacySaaS">
      <div className="space-y-6">
        ...
        {salesAnalytics && (
          <Card>
            <CardHeader>
              <CardTitle>Aperçu des ventes - {periods.find(p => p.value === selectedPeriod)?.label}</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div className="text-center">
                  <p className="text-2xl font-bold text-gray-900">
                    {salesAnalytics.dailySales?.reduce((sum, day) => sum + day.count, 0) || 0}
                  </p>
                ...
                <div className="text-center">
                  <p className="text-2xl font-bold text-gray-900">
                    {new Intl.NumberFormat('fr-FR', {
                      ...
                      salesAnalytics.dailySales?.reduce((sum, day) => sum + day.amount, 0) || 0
                    )}
                  </p>
