...
const FeaturesPage: NextPage = () => {
  const features: Feature[] = [
    {
      ...
      description: 'Système de caisse moderne avec gestion complète des transactions',
    ...
    },
    {
      ...
      description: 'Traitement sécurisé avec contrôle des interactions médicamenteuses',
    ...
    },
    {
      ...
      description: 'Intelligence économique avec tableaux de bord personnalisés',
      icon: ChartBarIcon,
      category: 'Analytics',
      benefits: [
  ...
  return (
    <>
      <Head>
        <title>Fonctionnalités - NakiCode PharmaSaaS</title>
        <meta name="description" content="Découvrez toutes les fonctionnalités avancées de notre plateforme SaaS de gestion pharmaceutique pour l'Afrique" />
        <meta name="keywords" content="pharmacie, gestion, logiciel, SaaS, Afrique, fonctionnalités" />
      </Head>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              ...
              <div className="flex items-center space-x-6">
                ...
                <Link href="/features" className="text-indigo-600 font-medium">Fonctionnalités</Link>
        ...
        <section className="bg-gradient-to-br from-indigo-900 via-indigo-800 to-purple-800 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Fonctionnalités <span className="text-indigo-300">Révolutionnaires</span>
            </h1>
            <p className="text-xl text-indigo-200 mb-8 max-w-3xl mx-auto">
              Une suite complète d'outils pharmaceutiques conçus pour optimiser vos opérations,
              respecter les réglementations africaines et maximiser votre rentabilité.
            </p>
            <div className="flex justify-center space-x-4">
              <Link 
                href="/demo" 
                className="bg-white text-indigo-900 px-8 py-3 rounded-lg font-semibold hover:bg-indigo-50 transition-colors focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-900"
              >
                Voir la Démo
              </Link>
              <Link 
                ...
                <div key={category} className="mb-20">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    {categoryFeatures.map((feature, index) => (
                      <div 
                        key={feature.id} 
                        className={`flex items-start space-x-6 ${index % 2 === 1 ? 'lg:flex-row-reverse lg:space-x-reverse lg:space-x-6' : ''}`}
                      >
                        ...
                        <div className="flex-1">
                          ...
                          {feature.specifications && (
                            <div className="bg-gray-50 p-4 rounded-lg">
                              <h4 className="font-semibold text-gray-900 mb-2">Spécifications Techniques</h4>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Notre plateforme intègre les spécificités du marché pharmaceutique africain
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: 'Support natif d\'AirtelMoney, OrangeMoney, M-Pesa, EcoCash et LumiCash',
                  icon: '📱'
                },
                {
                  title: 'Multi-Devises',
                  description: 'Gestion simultanée USD, CDF, BIF, EUR avec taux de change temps réel',
                  icon: '💱'
                },
                {
                  title: 'Conformité Réglementaire',
                  description: 'Respect des normes DRC, Burundi, EAC et standards internationaux WHO/EMA',
                  icon: '⚖️'
                },
                {
                  title: 'Langues Locales',
                  description: 'Interface en Français, Anglais, Lingala et Swahili',
                  icon: '🗣️'
                },
                {
                  title: 'Mode Hors Ligne',
                  description: 'Fonctionnement complet même sans connexion internet',
                  icon: '📶'
                },
                {
                  title: 'Support Local',
        ...
        <section className="bg-indigo-900 py-20">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-indigo-200 mb-8">
              Rejoignez plus de 500 pharmacies qui font confiance à NakiCode PharmaSaaS
            </p>
