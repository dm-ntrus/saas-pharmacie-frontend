...
export const MicroButton: React.FC<MicroButtonProps> = ({
  ...
  const variantClasses = {
    primary: "bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow-lg shadow-indigo-500/25 hover:shadow-xl hover:shadow-indigo-500/40 hover:-translate-y-0.5 focus-visible:ring-indigo-500",
    ...
    outline: "border-2 border-indigo-500 text-indigo-600 hover:bg-indigo-50 hover:shadow-md focus-visible:ring-indigo-500"
  };
  ...
  return (
    <button className={combinedClasses} {...props}>
      ...
      {/* Glow effect */}
      {animation === 'glow' && (
        <span className="absolute -inset-2 bg-gradient-to-r from-indigo-500/0 via-indigo-500/20 to-indigo-500/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl rounded-2xl" />
      )}

      {/* Magnetic field */}
      {animation === 'magnetic' && (
        <>
          <span className="absolute -inset-4 bg-gradient-to-r from-indigo-100/0 via-indigo-100/30 to-indigo-100/0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-2xl rounded-3xl" />
          <span className="absolute inset-0 bg-gradient-to-r from-indigo-400/0 to-purple-400/0 group-hover:from-indigo-400/10 group-hover:to-purple-400/10 transition-all duration-300 rounded-xl" />
        </>
      )}
