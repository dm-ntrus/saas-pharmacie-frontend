          ...
          <AnimatePresence mode="wait">
              ...
              >
                ...
                <form onSubmit={handleEmailSubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full py-4 bg-emerald-600 text-white rounded-xl font-bold hover:bg-emerald-700 transition-all flex items-center justify-center gap-2 disabled:opacity-70 shadow-lg shadow-emerald-600/15"
                  >
                    {isSubmitting ? (
              ...
              >
                ...
                <form onSubmit={handleOtpSubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full py-4 bg-emerald-600 text-white rounded-xl font-bold hover:bg-emerald-700 transition-all flex items-center justify-center gap-2 disabled:opacity-50 shadow-lg shadow-emerald-600/15"
                  >
                    {isSubmitting ? (
                      <Loader2 className="w-5 h-5 animate-spin" />
                    ) : (
            ...
            {step === 3 && (
              ...
              >
                ...
                <p className="text-sm text-slate-500 mb-5 leading-relaxed">
                  Choisissez un mot de passe sécurisé (min. 8 caractères, une
                ...
                <form onSubmit={handlePasswordSubmit} className="space-y-4">
                  ...
                  >
                    {isSubmitting ? (
                      ...
                      <>
                        Réinitialiser <ArrowRight className="w-5 h-5" />
                      </>
                    )}
                  </button>
                </form>
            ...
            {step === 4 && (
              ...
              >
                ...
                <Link
                  href="/auth/login"
                  className="inline-flex w-full py-4 bg-slate-900 text-white rounded-xl font-bold hover:bg-emerald-600 transition-all items-center justify-center gap-2"
                >
                  Se connecter
                  <ArrowRight className="w-5 h-5" />
                </Link>
