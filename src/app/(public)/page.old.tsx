...
<section className="relative min-h-screen flex items-center overflow-hidden">
        {/* Left Side - Content */}
        <div className="flex-1 relative z-20 pt-32 pb-20 px-8 lg:px-24">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <div className="inline-flex items-center gap-4 px-6 py-2 bg-slate-900 text-white rounded-full text-[8px] font-black mb-6 uppercase tracking-[0.4em] shadow-2xl">
              <span className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse"></span>
              Intégration IA pour l'optimisation des stocks
            </div>
            
            <h1 className="text-4xl lg:text-[90px] font-display font-bold text-slate-900 leading-[0.82] mb-6 tracking-[-0.06em]">
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-start lg:items-center">
              ...
              Jusqu'à 45% d'augmentation des marges avec notre plateforme SaaS tout-en-un.
              </p>
            ...
            {/* Micro Stats */}
            <div className="mt-8 grid grid-cols-3 gap-12 border-t border-slate-100 pt-6">
              <div>
        ...
        <div className="hidden lg:block flex-1 h-screen relative bg-slate-900">
          ...
          <motion.div
            ...
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] aspect-video bg-white rounded-[3rem] shadow-[0_100px_200px_-50px_rgba(0,0,0,0.5)] border border-white/20 overflow-hidden z-20"
          >
      ...
      <section className="pt-20 bg-gradient-to-br from-sky-50 via-sky-50 to-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-sky-500/50 to-white/80"></div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 xl:py-24 relative">
          <div className="relative overflow-hidden text-center lg:text-end">
            <div className="relative  z-10 text-center lg:text-end">
              <div className="inline-flex items-center bg-gradient-to-r from-sky-100/30 to-sky-100/30 text-white px-6 py-3 rounded-full text-sm font-medium mb-2 shadow-soft hover:shadow-soft-lg transition-all duration-300 hover:scale-105">
              ...
              <p className="text-xl md:text-2xl text-white mb-8 leading-tight font-light animate-fade-in-up delay-500">
                Automatisation complète, optimisation des ventes et conformité
                garantie.
                <br /> Jusqu'à{" "}
                <span className="font-thin text-green-600 bg-white/30 backdrop-blur-sm px-3 py-1 rounded-full">
                  45% d'augmentation des marges
                </span>{" "}
                avec notre plateforme SaaS tout-en-un.
              </p>

              <div className="flex flex-col md:flex-row gap-4 justify-center lg:justify-end mb-8 animate-fade-in-up delay-700">
                <Link href="/register">
                  <Button size="lg">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              ...
              africaines modernes, avec intelligence artificielle intégrée pour
          ...
          <div className="bg-gradient-to-br from-sky-900 via-sky-800 to-cyan-800 rounded-4xl shadow-2xl p-8 md:p-12 text-white relative overflow-hidden">
            ...
            <div className="text-center mb-8 relative">
              ...
              <p className="text-sky-100 text-lg max-w-3xl mx-auto">
                ...
                prédictions ultra-précises et des optimisations automatiques qui
            ...
            <section className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
              ...
              <div className="group text-center bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                ...
                <p className="text-sky-100 text-sm leading-relaxed">
                  Maximisez vos marges avec des stratégies de prix dynamiques et
                  intelligentes
                </p>
              </div>
              <div className="group text-center bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 hover:scale-105">
                ...
                <h4 className="font-bold mb-3 text-lg">Fidélisation Client</h4>
                <p className="text-sky-100 text-sm leading-relaxed">
                  Personnalisez les promotions et améliorez l'expérience client
                  avec l'IA
                </p>
              </div>
            </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Découvrez comment NakiCode PharmacySaaS transforme la gestion des
              pharmacies en République Démocratique du Congo et au Burundi
            </p>
          </div>
