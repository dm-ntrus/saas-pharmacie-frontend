  ...
  const incidents: Incident[] = [
    {
      ...
      description:
        "Délais de réponse élevés observés sur les transactions AirtelMoney et OrangeMoney.",
      updates: [
        {
        ...
        },
        {
          ...
          message:
            "Problème identifié côté opérateur. Mise en place d'une solution de contournement.",
          status: "identified",
        },
        {
          time: "2025-01-21T16:10:00Z",
          message:
            "Amélioration constatée. Surveillance continue des performances.",
          status: "monitoring",
        },
      ],
    },
    {
      ...
      description:
        "Maintenance planifiée pour appliquer les correctifs de sécurité critiques.",
      updates: [
        {
        ...
        },
        {
          ...
          message:
            "Maintenance terminée. Tous les services sont opérationnels.",
          status: "resolved",
        },
      ],
    },
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Surveillance en temps réel de l'état des services NakiCode PharmaSaaS. Disponibilité, incidents et maintenance."
        />
        <meta
          name="keywords"
          content="statut, disponibilité, uptime, incidents, maintenance, monitoring"
        />
      </Head>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              ...
              <div className="flex items-center space-x-6">
                ...
                <Link href="/status" className="text-sky-600 font-medium">
                  Statut
                </Link>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-sm text-gray-500">
              Surveillance automatique toutes les 30 secondes depuis Kinshasa,
              Bujumbura et Johannesburg
            </p>
          </div>
                        ...
                        <div className="h-full flex">
                          {Array.from({ length: 24 }, (_, i) => (
                            <div
                              key={i}
                              className={`flex-1 ${
                                service.status === "outage" && i === 23
                                  ? "bg-red-500"
                                  : service.status === "degraded" && i >= 22
                                  ? "bg-yellow-500"
                                  : "bg-green-500"
            ...
            {incidents.length > 0 ? (
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="text-right text-sm text-gray-500">
                        ...
                        {incident.resolvedTime && (
                          <div>
                            Résolu:{" "}
                            {new Date(incident.resolvedTime).toLocaleString(
                              "fr-FR"
                            )}
                          </div>
                        )}
              ...
              <div className="bg-white rounded-xl p-12 text-center shadow-sm border border-gray-200">
                ...
                <p className="text-gray-600">
                  Tous nos services fonctionnent parfaitement.
                </p>
              </div>
            )}
          </section>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>
                  • <strong>Kinshasa (Primaire):</strong> Centre de données
                  principal
                </li>
                <li>
                  • <strong>Johannesburg:</strong> Réplication et backup
                </li>
                <li>
                  • <strong>Lagos:</strong> Cache et distribution
                </li>
                <li>
                  • <strong>CDN Global:</strong> Cloudflare avec 30+ points de
                  présence
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                <li>
                  • <strong>Disponibilité:</strong> 99.9% (8h 45min/an maximum)
                </li>
                <li>
                  • <strong>Temps de réponse API:</strong> &lt; 500ms (99e
                  percentile)
                </li>
                <li>
                  • <strong>RTO:</strong> &lt; 4h en cas d'incident majeur
                </li>
                <li>
                  • <strong>RPO:</strong> &lt; 15 minutes de perte de données
                </li>
              </ul>
            </div>
          </section>
