...
export default function ApiDocsPage() {
  ...
  const highlights = [
    { icon: Key, title: t("authJwt"), desc: t("authJwtDesc") },
    { icon: Webhook, title: t("webhooks"), desc: t("webhooksDesc") },
    { icon: FileText, title: t("openApi"), desc: t("openApiDesc") },
  ];
