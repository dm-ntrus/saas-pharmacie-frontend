  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Sélectionnez le plan NakiCode PharmaSaaS qui correspond à vos besoins. Premier mois gratuit, aucun engagement."
        />
        <meta
          name="keywords"
          content="plans, tarifs, pharmacie, saas, abonnement"
        />
      </Head>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-sky-200 mb-8 max-w-3xl mx-auto">
              Sélectionnez l'offre qui correspond parfaitement aux besoins de
              votre pharmacie. Premier mois gratuit, aucun engagement.
            </p>
          ...
          <div className="bg-white/10 rounded-2xl p-8 backdrop-blur mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-sky-200 mb-4">
                  3-5 employés, 500-2000 produits
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-sky-200">
                  ...
                  moment. Les changements sont effectifs immédiatement.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sky-200">
                  Non, le prix affiché est tout inclus. Pas de frais
                  d'installation, de formation ou de support supplémentaires.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-sky-200">
                  30 jours complets avec toutes les fonctionnalités. Aucune
              ...
              <div>
                ...
                <p className="text-sky-200">
                  Oui, tous nos plans incluent le support technique. Les plans
                  supérieurs ont un support prioritaire.
                </p>
              </div>
            </div>
          </div>
