...
const ControlledSubstancesPage: React.FC = () => {
  ...
  const [selectedLog, setSelectedLog] = useState<ControlledSubstanceLog | null>(
    null
  );
  ...
  const getActionColor = (action: string) => {
    const color =
      availableActions.find((a) => a.value === action)?.color || "gray";
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p
                className={`text-sm font-medium ${
                  selectedLog.quantity > 0 ? "text-green-600" : "text-red-600"
                }`}
              >
                {selectedLog.quantity > 0 ? "+" : ""}
            ...
            <div>
              ...
              <span
                className={`inline-flex items-center px-2 py-1 rounded-full text-xs bg-${
                  getRiskLevel(selectedLog.deaSchedule).color
                }-100 text-${getRiskLevel(selectedLog.deaSchedule).color}-800`}
              >
          ...
          {selectedLog.prescriber && (
            <div>
              ...
              <p className="text-sm text-gray-900">
                Dr. {selectedLog.prescriber.firstName}{" "}
                {selectedLog.prescriber.lastName}
                {selectedLog.prescriber.licenseNumber &&
                  ` (${selectedLog.prescriber.licenseNumber})`}
              </p>
            </div>
          )}
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Historique complet des mouvements de substances contrôlées pour la
                    ...
                    <div className="flex items-center gap-2 text-sm text-gray-600 pt-2 border-t border-gray-200">
                      ...
                      {filters.deaSchedule && (
                        <span className="inline-flex items-center px-2 py-1 rounded-full text-xs bg-purple-100 text-purple-800">
                          DEA:{" "}
                          {getDEAScheduleLabel(
                            filters.deaSchedule as DEASchedule
                          )}
                          <button
                            onClick={() =>
                              handleFilterChange({ deaSchedule: "" })
                            }
