    ...
    >
      ...
      <div className="bg-white pt-10">
                ...
                <div className="bg-gray-900/10 backdrop-blur-sm rounded-2xl p-8">
                  <div className="aspect-video bg-gray-900 rounded-xl flex items-center justify-center mb-6">
                    <div className="text-center">
                      ...
                      <p className="text-white text-lg font-semibold">Aperçu de l'Interface</p>
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-900 mb-6">Démo Interactive Complète</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Explorez toutes les fonctionnalités avec des données réalistes. Aucune inscription requise.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 mb-12">
              <div className="aspect-video bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl flex items-center justify-center relative overflow-hidden">
                <div className="text-center z-10">
                  ...
                  <h3 className="text-3xl font-bold text-white mb-4">Système Complet En Action</h3>
                  <p className="text-gray-300 text-lg mb-8 max-w-md mx-auto">
                    Point de vente, gestion des stocks, comptabilité, Mobile Money - tout y est
                  </p>
                  <Button size="lg">
                ...
                >
                  <div className="flex flex-col lg:flex-row items-center lg:items-start lg:justify-between">
                    <div className="flex flex-col lg:flex-row items-center lg:items-start text-center lg:text-left mb-6 lg:mb-0">
                      <div className={`${selectedDemo === option.id ? 'bg-sky-600' : 'bg-gray-400'} w-20 h-20 rounded-2xl flex items-center justify-center mb-6 lg:mb-0 lg:mr-8 transition-colors`}>
                        <option.icon className="h-10 w-10 text-white" />
                      </div>
                      <div className="flex-1">
                        <div className="flex items-center justify-center lg:justify-start mb-4">
                          <h3 className="text-2xl font-bold text-gray-900 mr-4">{option.name}</h3>
                    ...
                    <div className="flex-shrink-0">
                      <Button
                        variant={selectedDemo === option.id ? "default":"secondary"}
                      >
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Démonstration Multi-Tenant</h2>
              <p className="text-xl text-gray-600 max-w-4xl mx-auto">
                Chaque pharmacie dispose de son propre domaine personnalisé et de ses données isolées. Testez le système multi-tenant avec nos pharmacies de démonstration.
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-8">
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-6">Sélectionnez une pharmacie de test</h3>
                  <div className="space-y-4">
                    {[
                      { name: 'Pharmacie Centrale', type: 'Pharmacie urbaine', features: ['POS avancé', 'Multi-utilisateurs', 'Comptabilité'] },
                      { name: 'Pharmacie Populaire', type: 'Pharmacie de quartier', features: ['POS simple', 'Mobile Money', 'Alertes SMS'] },
                      { name: 'Pharmacie Hospitalière', type: 'Établissement hospitalier', features: ['Gestion hospitalière', 'Prescriptions', 'Traçabilité'] }
                    ].map((pharmacy, index) => (
                      <div key={index} className="p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors cursor-pointer">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-sm text-gray-600">{pharmacy.type}</p>
                          </div>
                          <ArrowRightIcon className="h-5 w-5 text-gray-400" />
                        </div>
                        <div className="flex flex-wrap gap-2 mt-2">
                          {pharmacy.features.map((feature, idx) => (
                            <span key={idx} className="text-xs bg-sky-100 text-sky-800 px-2 py-1 rounded-full">
                              {feature}
                            </span>
                          ))}
                        </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="text-white">
                ...
                <h2 className="text-4xl font-bold mb-6">Démo Personnalisée avec Expert</h2>
              ...
              <div className="bg-sky-800 rounded-2xl p-8">
                <h3 className="text-xl font-bold text-white mb-6">Créneaux Disponibles</h3>
                <div className="grid grid-cols-1 gap-4">
                  {[
                    { day: 'Mardi 28 Août', time: '14h00 - 14h45', expert: 'Marie K.', available: true },
                    { day: 'Mercredi 29 Août', time: '10h00 - 10h45', expert: 'Jean-Paul M.', available: true },
                    { day: 'Jeudi 30 Août', time: '16h00 - 16h45', expert: 'Sarah D.', available: false },
                    { day: 'Vendredi 31 Août', time: '09h00 - 09h45', expert: 'David L.', available: true }
                  ].map((slot, index) => (
                    <div
                      key={index}
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          {!slot.available && <div className="text-xs mt-1 text-cyan-100">Complet</div>}
                        </div>
                      </div>
                    </div>
                  ))}
              ...
              {[
                {
                  ...
                  description: 'PDF complet pour bien commencer avec la plateforme',
                  action: 'Télécharger',
                  color: 'bg-blue-500',
                  icon: '📚'
                },
                ...
                <div key={index} className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow group">
                  <div className={`${resource.color} w-16 h-16 rounded-xl flex items-center justify-center mx-auto mb-6`}>
                    <span className="text-2xl">{resource.icon}</span>
                  </div>
                  <h3 className="text-xl font-bold text-gray-900 mb-3 text-center">{resource.title}</h3>
                  <p className="text-gray-600 mb-6 text-center leading-relaxed">{resource.description}</p>
